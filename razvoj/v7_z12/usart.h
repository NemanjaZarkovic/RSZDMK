...
/**
 * Funkcija proverava koji je sledeci neprocitani karakter iz prijemnog bafera. Ukoliko je prijemni bafer prazan, vraca -1.
 * @return sledeci neprocitani karakter iz prijemnog bafera
 */
int8_t usartCheck();

/**
 * Funkcija vraca prvi validan, ceo broj iz prijemnog bafera
 * @return naredni validan broj ili vrednost 0, ukoliko on nije pronadjen
 */
int32_t usartParseInt();

/**
 * Funkcija koja pretvara ceo broj u niz karaktera i salje ga putem serijskog porta
 * @param value ceo broj koji se pretvara
 */
void usartPrintHexaDecimal(int32_t value);
